  ...
  return (
    <AuroraBackground className="">
      ...
      >
        ...
        <div className="font-extralight text-base md:text-2xl text-center dark:text-neutral-200 py-4">
        Krishna Chaturvedi born on 17 September, 1996 in Rewa, Madhyapradesh is an Indian singer. He got fame after his song; Mera Malik hai shivaya (Mera Bholenath) & Door Na hona shambhu #34; start getting popularity on social media platforms. As of May 2023 this song has grossed Millions views on YouTube other platforms. He is a Devotional Bollywood Singer in India.
        </div>
        <div className="flex ">
